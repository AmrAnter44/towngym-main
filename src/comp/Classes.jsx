...
export default function Home() {
  const [classes, setClasses] = useState([
    ...
    { id: 9, className: "belly dance", day: "Wednesday", time1: "8:00",coachName:"menna",mix:"Mix" },
    // { id: 10, className: "Superman Kids", day: "Thursday", time1: "6:00",coachName:"Zima",mix:"Mix",Mem:true  },
    { id: 11, className: "core", day: "Thursday", time1: "8:00",coachName:"zima",mix:"Mix",Mem:true  },
