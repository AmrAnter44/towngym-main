...
{/* new  */}
    {coaches?.length > 0   ? 
 coaches?.map((coache)=>     <div key={coache.id} className="w-80 bg-blue-800 rounded-lg bg-opacity-70 text-white justify-between flex flex-col-reverse md:flex-row pt-2 gap-2 border">
